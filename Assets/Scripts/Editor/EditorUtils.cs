...
public class EditorUtils
{
    ...
    /// <summary>
    /// Displays a menu item in the GameObject menu and an entry in the context menu of a transform.
    /// Centers the transform pivot to the mesh bounds.
    /// </summary>
    ...
    /// <summary>
    /// Moves the Object's Pivot into the Object's Center thus centering the Pivot!
